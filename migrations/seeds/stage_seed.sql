...
--
-- This file contains initial seed data for the deal.stages table.
-- Customize this file to add your initial data.

-- INSERT INTO deal.stages (
--     id,
--     company_id,
--     code,
--     name,
...
-- INSERT INTO deal.stages (id, code, name, is_active, created_at, updated_at) VALUES
