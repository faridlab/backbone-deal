...
/// Request DTO for full update of a Campaign
///
...
/// Request DTO for partial update of a Campaign
///
...
/// Response DTO for Campaign entity
///
...
/// Paginated list response for Campaign entities
///
...
pub struct CampaignListResponseDto {
    /// List of items
    pub items: Vec<CampaignResponseDto>,
...
impl CampaignListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<CampaignResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<Campaign> for CampaignSummaryDto {
    fn from(entity: Campaign) -> Self {
...
impl From<CreateCampaignDto> for Campaign {
...
impl backbone_core::FromCreateDto<CreateCampaignDto> for Campaign {
    fn from_create_dto(dto: CreateCampaignDto) -> backbone_core::ServiceResult<Self> {
        Ok(Campaign::from(dto))
    }
}
