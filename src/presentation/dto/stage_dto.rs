...
pub struct PatchStageDto {
    ...
    #[cfg_attr(feature = "openapi", schema(example = true))]
    #[serde(skip_serializing_if = "Option::is_none", alias = "is_won")]
    pub is_won: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none", alias = "probability_hint")]
    pub probability_hint: Option<Decimal>,
    #[cfg_attr(feature = "openapi", schema(example = true))]
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl From<Stage> for StageResponseDto {
    fn from(entity: Stage) -> Self {
        Self {
            ...
            is_won: entity.is_won,
            probability_hint: entity.probability_hint,
...
impl From<CreateStageDto> for Stage {
    fn from(dto: CreateStageDto) -> Self {
        Self {
            ...
            is_won: dto.is_won,
            probability_hint: dto.probability_hint,
            active: dto.active,
...
impl From<&Stage> for StageResponseDto {
    fn from(entity: &Stage) -> Self {
        Self {
            ...
            is_won: entity.is_won.clone(),
            probability_hint: entity.probability_hint.clone(),
...
impl backbone_core::ApplyUpdateDto<UpdateStageDto> for Stage {
    fn apply_update(mut self, dto: UpdateStageDto) -> backbone_core::ServiceResult<Self> {
        ...
        self.is_won = dto.is_won;
        self.probability_hint = dto.probability_hint;
