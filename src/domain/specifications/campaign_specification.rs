//! Specifications for Campaign aggregate
//!
...
// Each predicate implements `Specification<Campaign>` and can be combined
...
//
// pub struct ActiveCampaignSpec;
// impl Specification<Campaign> for ActiveCampaignSpec {
//     fn is_satisfied_by(&self, e: &Campaign) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
