//! Specifications for Opportunity aggregate
//!
...
// Each predicate implements `Specification<Opportunity>` and can be combined
...
//
// pub struct ActiveOpportunitySpec;
// impl Specification<Opportunity> for ActiveOpportunitySpec {
//     fn is_satisfied_by(&self, e: &Opportunity) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
