//! Domain policy for OpportunityItem aggregate
//!
...
/// Domain policy for OpportunityItem — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<OpportunityItem>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type OpportunityItemDomainPolicy = PermitAllPolicy<OpportunityItem>;
