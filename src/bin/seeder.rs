//! Database seeder binary for module: deal
//!
//! Generated by metaphor-schema. Do not edit manually.
//!
//! Run with: cargo run --bin deal-seeder
//! Or via CLI: backbone seed run --module deal
//!
...
async fn main() -> Result<()> {
    ...
    println!();
    println!("Running seeders for module: deal");
    println!();
